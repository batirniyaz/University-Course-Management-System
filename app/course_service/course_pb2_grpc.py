...
import app.course_service.course_pb2 as course__pb2
...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourseById = channel.unary_unary(
                ...
                request_serializer=course__pb2.GetCourseByIdRequest.SerializeToString,
                response_deserializer=course__pb2.GetCourseByIdResponse.FromString,
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCourseById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=course__pb2.GetCourseByIdRequest.FromString,
                    response_serializer=course__pb2.GetCourseByIdResponse.SerializeToString,
            ),
    }
...
class CourseService(object):
    ...
    def GetCourseById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/course.CourseService/GetCourseById',
            course__pb2.GetCourseByIdRequest.SerializeToString,
            course__pb2.GetCourseByIdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
